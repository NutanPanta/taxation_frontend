            ...
            <Grid item xs={6}>
              <Select
                ...
                values={[
                  ...
                  { type: 'Pension Income' },
                  { type: 'Gambling Winnings' },
                  { type: 'Prizes and Awards' },
                ]}
              />
            </Grid>
            <Grid item xs={5}>
              <LabeledInput
                name={`other_incomes.${key}.income`}
                label={'Income'}
                type='number'
                size='small'
                formik={formik}
      ...
      <Box>
        ...
        {formik.values.deductions.map((_, key) => (
          <Grid container spacing={2} key={key}>
            <Grid item xs={6}>
              <Select
                name={`deductions.${key}.income_type`}
                ...
                values={[
                  ...
                  { type: 'Miscellaneous Deductions' },
                ]}
              />
            </Grid>
            <Grid item xs={5}>
              <LabeledInput
                name={`deductions.${key}.income`}
                type='number'
                label={'Income'}
                size='small'
                formik={formik}
